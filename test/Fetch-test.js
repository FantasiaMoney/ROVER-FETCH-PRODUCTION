...
contract('Fetch-test', function([userOne, userTwo, userThree]) {
  ...
  async function deployContracts(){
    ...
    // add token liquidity to Pancake for TOKEN
...
describe('DEPOSIT without LD from sale', function() {
    ...
    it('', async function() {
      ...
      const splitData = await fetch.calculateToSplit(toWei(String(10)))
      ...
      console.log("Rate for 1 TOKEN without add LD", Number(initialRate[1]), "ETH wei")
